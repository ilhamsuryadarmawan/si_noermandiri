...
<html lang="en">
  ...
  <body>
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="banner_content text-center">
                ...
                <div>
                  <a href="#pendaftaran_siswa_baru" class="primary-btn2 mb-3 mb-sm-0">Pendaftaran Siswa Baru</a>
    ...
    <div class="section_gap registration_area" id="pendaftaran_siswa_baru">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5">
            <div class="main_title">
        ...
        <div class="row align-items-center">
          <div class="col-lg-10 offset-lg-1">
            <div class="register_form">
              ...
              <form class="form_area"id="myForm"action="" method="post">
                <div class="row">
