                                    ...
                                    <table id="multi-filter-select" class="display table table-striped table-hover" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <!--     <a href="<?php echo base_url('C_kelas/hapus/'.$id)?>" class="tombol_hapus">&nbsp<button class="btn btn-warning btn-sm"><i class="fa fa-trash"></i></button></a> -->
                                                </td>
                  ...
                  <div class="modal-body">
                    <form action="<?php echo base_url('updatekelas')?>" method="POST">
                        <div class="form-group form-inline">
                            <label for="inlineinput" class="col-md-3 col-form-label">ID Kelas</label>
                        ...
                        <div class="form-group form-inline">
                            <label for="inlineinput" class="col-md-3 col-form-label">Jenjang Kelas</label>
                            <div class="col-md-9 p-0">
                                <input type="text" class="form-control input-full" placeholder="Enter Input" name="jenjang_edit" id="jenjang_edit" value="<?php echo $jenjang?>" readonly>
                            </div>
                        </div>
                        <div class="form-group form-inline">
                        ...
                        <div class="form-group form-inline">
                            <label for="inlineinput" class="col-md-3 col-form-label">Status Kelas</label>
                            <div class="col-md-9 p-0">
