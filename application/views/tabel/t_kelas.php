                                    ...
                                    <table id="multi-filter-select" class="display table table-striped table-hover" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><button class="btn btn-primary btn-sm" id="btnEdit" data-toggle="modal" data-target="#modal_edit<?php echo $id?>"><i class="fa fa-pencil-alt"></i></button><a href="<?php echo base_url('C_kelas/hapus/'.$id)?>" class="tombol_hapus">&nbsp<button class="btn btn-warning btn-sm"><i class="fa fa-trash"></i></button></a></td>
